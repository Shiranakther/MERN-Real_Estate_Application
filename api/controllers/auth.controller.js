...
export const google = async(req,res,next) =>{
    try{
        ...
        if(user){
            ...
            const genetaredPassword = Math.random().toString(36).substring(2,15) + Math.random().toString(36).slice(-8)+Math.random().toString(36).substring(2,15) + Math.random().toString(36).slice(-8);
            const hashedPassword = bcryptjs.hashSync(genetaredPassword, 10);
